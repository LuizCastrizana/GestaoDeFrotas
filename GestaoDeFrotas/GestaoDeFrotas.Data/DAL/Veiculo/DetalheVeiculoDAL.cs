...
{
    public class DetalheVeiculoDAL : OracleBaseDAL
    {
        ...
        public IEnumerable<DetalheVeiculoDAL> ListarDetalhe(int tipo)
        {
            List<DetalheVeiculoDAL> listaDetalhes = new List<DetalheVeiculoDAL>();
            ...
            using (Comando = new OracleCommand(comandoSql, Conexao))
            {
                ...
                using (var reader = Comando.ExecuteReader())
                {
                    if (reader.HasRows)
                    {
                        while (reader.Read())
                        {
                            DetalheVeiculoDAL detalhe = new DetalheVeiculoDAL();
